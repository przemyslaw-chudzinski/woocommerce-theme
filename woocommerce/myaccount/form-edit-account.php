	...
	<div class="row">
        <div class="col-xs-12 col-md-6">
            <div class="form-wrapper">
                <h3 class="title-underblock custom mb40"><?php _e( 'Dane konta', 'woocommerce' ); ?></h3>
                ...
                <input type="submit" class="woocommerce-Button button btn btn-custom" name="save_account_details" value="<?php esc_attr_e( 'Save changes', 'woocommerce' ); ?>" />
            </div>
        </div>
        <div class="col-md-6 col-xs-12">
            <div class="form-wrapper">
                <fieldset>
                    ...
                    <h3 class="title-underblock custom mb40"><?php _e( 'Password change', 'woocommerce' ); ?></h3>
