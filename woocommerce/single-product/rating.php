...
<!--	</div>-->
    ...
    <div class="woocommerce-product-rating">
        <div class="product-ratings-container">
            <?= belli_get_rating_html($average, $rating_count); ?>

            <span class="product-ratings-count"><?= esc_html($review_count); ?> Review(s)</span>
            <?php if(comments_open()): ?>
                    <span class="separator ">|</span> <a href="#reviews" clasS="product-ratings-add woocommerce-review-link" rel="nofollow">Add your review</a>
            <?php endif; ?>
