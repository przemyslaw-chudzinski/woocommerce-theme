		...
		<table class="variations" cellspacing="0">
			<tbody>
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
					<tr>
						<td class="label">
<!--                            <label class="label label-primary" for="--><?php //echo sanitize_title( $attribute_name ); ?><!--">--><?php //echo wc_attribute_label( $attribute_name ); ?><!--</label>-->
						...
						<td class="value">
							<?php
								...
								echo end( $attribute_keys ) === $attribute_name ? apply_filters( 'woocommerce_reset_variations_link', '<a class="reset_variations btn btn-custom btn-xs belli-clear-btn" href="#">' . esc_html__( 'Clear', 'woocommerce' ) . '</a>' ) : '';
							?>
						</td>
					</tr>
				<?php endforeach;?>
