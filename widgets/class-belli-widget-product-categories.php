...
if (class_exists('WC_Widget')) {
    class WC_Belli_Widget_Product_Categories extends WC_Widget {
        ...
        public function __construct() {
            ...
            $this->widget_name        = __( 'BELLI Product Categories', 'woocommerce' );
            $this->settings           = array(
                'title'  => array(
                    'type'  => 'text',
        ...
        public function widget( $args, $instance ) {
			...
			" );
                ...
                require_once __DIR__.DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'walkers'.DIRECTORY_SEPARATOR.'class-product-cat-list-walker.php';
                ...
                <?= isset($args['before_title']) && !empty($args['before_title']) && $args['before_title'] !== '' ? $args['before_title'] : '<h3>' ?>
                <?= $instance['title']; ?>
                <?= isset($args['after_title']) && !empty($args['after_title']) && $args['after_title'] !== '' ? $args['after_title'] : '</h3>' ?>
