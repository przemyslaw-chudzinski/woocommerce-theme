...
class Belli_Comment_Walker extends Walker_Comment
{
    ...
    public function start_lvl( &$output, $depth = 0, $args = array() ) {
        ...
        switch ( $args['style'] ) {
            case 'div':
                break;
            case 'ol':
                $output .= '<ol class="children comments-list media-list">' . "\n";
                break;
            case 'ul':
            default:
                $output .= '<ul class="children comments-list media-list">' . "\n";
                break;
        }
    }
    ...
    protected function comment( $comment, $depth, $args ) {
        ...
        <div class="comment-author vcard">
            <?php if ( 0 != $args['avatar_size'] ) echo get_avatar( $comment, $args['avatar_size'], '', '' , ['class' => 'media-object img-circle'] ); ?>
            <?php
            ...
            <div class="comment-meta media-body">
                <div class="comment-metadata">
                    ...
                    comment_reply_link( array_merge( $args, array(
                        ...
                        'depth'     => $depth,
                        'max_depth' => $args['max_depth'],
                        'before'    => '<div class="reply reply-link">',
                        'after'     => '</div>'
                    ) ) );
                    ?>
