...
(function ($) {
	...
	window.Boss = {
		...
		priceSlider:function () {
			...
			const minPrice = $priceRange.data('min-price');
			const maxPrice = $priceRange.data('max-price');
			const currentMinPrice = parseFloat($priceRange.data('current-min-price'));
			const currentMaxPrice = parseFloat($priceRange.data('current-max-price'));
